...
class _OperatorProfilePageState extends State<OperatorProfilePage> {
  ...
  Future<void> _fetchProfile() async {
    ...
    final url = '${Apiconst.base_url}operator/profile/';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (decoded['success'] == true) {
          ...
          nameCtrl.text = data['operator_name'] ?? '';
          emailCtrl.text = data['operator_email'] ?? '';
          phoneCtrl.text = data['operator_phone']?.toString() ?? '';
        }
      }
    } catch (e) {
  ...
  Future<void> _updateProfile() async {
    ...
    final response = await http.put(
      ...
      body: jsonEncode({
        "operator_name": nameCtrl.text.trim(),
        "operator_email": emailCtrl.text.trim(),
        "operator_phone": phoneCtrl.text.trim(),
    ...
    if (response.statusCode == 200 && decoded['success'] == true) {
      final prefs = await SharedPreferences.getInstance();
      await prefs.setString('operator_name', nameCtrl.text.trim());
      await prefs.setString('operator_email', emailCtrl.text.trim());
